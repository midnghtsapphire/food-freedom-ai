"""Configuration for Food Freedom AI."""
from pydantic_settings import BaseSettings
from functools import lru_cache

class Settings(BaseSettings):
    APP_NAME: str = "Food Freedom AI"
    APP_URL: str = "http://localhost:8004"
    DATABASE_URL: str = "postgresql://appuser:password@db:5432/foodfreedom"
